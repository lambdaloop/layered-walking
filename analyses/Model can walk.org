...
#+RESULTS:
: 100%|██████████████████████████████| 171/171 [00:00<00:00, 274.24it/s]
...
#+BEGIN_SRC jupyter-python
sns.histplot(np.mod(phased['phase_L1'] - phased['phase_R1'], 2*np.pi))
#+END_SRC

#+RESULTS:
:RESULTS:
: <AxesSubplot:ylabel='Count'>
[[file:./.ob-jupyter/e37b2d82d293ef63476e6ea163be306ac053a708.png]]
:END:

#+BEGIN_SRC jupyter-python
d = phased[phased['type'] == 'real']
sns.kdeplot(np.mod(d['phase_L1'] - d['phase_R1'], 2*np.pi), cut=-2, bw_method=0.1)
plt.ylim(0, 0.5)
#+END_SRC
...
:RESULTS:
| 0.0 | 0.5 |
[[file:./.ob-jupyter/afd3a257edcc3b50eba2efc99c01b58e278f00da.png]]
:END:
