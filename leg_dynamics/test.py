...
bcFlexAvg = math.radians(150) # body-coxa flexion
cfFlexAvg = math.radians(60)  # coxa-femur flexion
cfRotAvg  = math.radians(165) # coxa-femur rotation
ftFlexAvg = math.radians(95)  # femur-tibia flexion
